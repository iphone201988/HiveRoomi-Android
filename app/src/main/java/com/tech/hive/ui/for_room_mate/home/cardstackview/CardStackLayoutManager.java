package com.tech.hive.ui.for_room_mate.home.cardstackview;
...
import com.tech.hive.ui.for_room_mate.home.cardstackview.internal.CardStackSetting;
import com.tech.hive.ui.for_room_mate.home.cardstackview.internal.CardStackSmoothScroller;
import com.tech.hive.ui.for_room_mate.home.cardstackview.internal.CardStackState;
import com.tech.hive.ui.for_room_mate.home.cardstackview.internal.DisplayUtil;
...
public class CardStackLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private void updateOverlay(View view) {
        View leftOverlay = view.findViewById(R.id.leftOverlay);
        if (leftOverlay != null) {
            leftOverlay.setAlpha(0.0f);
        }
        View rightOverlay = view.findViewById(R.id.rightOverlay);
        if (rightOverlay != null) {
            rightOverlay.setAlpha(0.0f);
        }
        View topOverlay = view.findViewById(R.id.topOverlay);
        if (topOverlay != null) {
