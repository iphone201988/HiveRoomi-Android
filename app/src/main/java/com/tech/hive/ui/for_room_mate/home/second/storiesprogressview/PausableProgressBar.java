package com.tech.hive.ui.for_room_mate.home.second.storiesprogressview;
...
final class PausableProgressBar extends FrameLayout {
    ...
    void setMaxWithoutCallback() {
        maxProgressView.setBackgroundResource(R.color.start_color);
    ...
    private void finishProgress(boolean isMax) {
        if (isMax) maxProgressView.setBackgroundResource(R.color.start_color);
